...
export default (code, flags) => {
  ...
  if (Prefs.pgo) {
    if (Prefs.pgoLog) {
      const oldSize = assemble(funcs, globals, tags, pages, data, flags, exceptions, true).byteLength;
      ...
      const newSize = assemble(funcs, globals, tags, pages, data, flags, exceptions, true).byteLength;
  ...
  const wasm = out.wasm = assemble(funcs, globals, tags, pages, data, flags, exceptions);
